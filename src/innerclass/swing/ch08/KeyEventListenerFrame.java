...
/**
 * KeyEventListenerFrame 인터페이스를 구현하여 키보드 이벤트를 처리하는 클래스를 설계
...
public class KeyEventListenerFrame  extends JFrame implements KeyListener {
    ...
    public void keyReleased(KeyEvent e) {
        //System.out.println("key Released 호출 됨");
    }
